    ...
    <div class="max-w-md mx-auto mt-8 p-6 bg-white rounded-lg shadow-xl">
        ...
        <form id="login-form" >
            <div class="mb-4">
                ...
                <input id="login-email" type="email" name="email" value="<?php echo $data['email'];?>" 
                    class="mt-1 p-2 w-full border rounded-md">
                <span id="login-email-err" class="text-red-500"> <?php echo $data['email_err']; ?> </span>
            </div>
            <div class="mb-4">
                <label for="password" class="block text-gray-600">Password: *</label>
                <input id="login-password" type="password" name="password" value="<?php echo $data['password'];?>" 
                    class="mt-1 p-2 w-full border rounded-md">
                <span id="login-password-err" class="text-red-500"> <?php echo $data['password_err']; ?> </span>
            </div>
